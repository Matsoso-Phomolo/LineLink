...
class Tenant(Base, TimestampMixin):
    ...
    tenant_category: Mapped[str | None] = mapped_column(String(40), index=True)
    tenant_subtype: Mapped[str | None] = mapped_column(String(80), index=True)
    ...
    sponsor_or_guardian_name: Mapped[str | None] = mapped_column(String(255))
    occupation: Mapped[str | None] = mapped_column(String(255))
    employer_or_business_name: Mapped[str | None] = mapped_column(String(255))
    work_location: Mapped[str | None] = mapped_column(String(255))
    number_of_occupants: Mapped[int | None] = mapped_column(Integer)
    children_count: Mapped[int | None] = mapped_column(Integer)
    parking_required: Mapped[bool | None] = mapped_column(Boolean)
    funding_source: Mapped[str | None] = mapped_column(String(255))
    guarantor_name: Mapped[str | None] = mapped_column(String(255))
    additional_notes: Mapped[str | None] = mapped_column(Text)
